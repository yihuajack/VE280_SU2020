...
// Type: Post_t
// ------------------
// The type Post_t is used to represent a post
// It consists of:
...
// Type: User_t
// ------------------
// The type User_t is used to represent a user
// It consists of:
...
// Type: Server_t
// ------------------
// The type Server_t is used to represent a server
// It consists of:
...
*/
{
    ...
    Tag_t tags[MAX_USERS * MAX_POSTS * MAX_TAGS];
