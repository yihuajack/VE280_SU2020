...
{
    // TODO:
    if (250 * num_pies > flour_remain) {
        float flour = 250 * num_pies - flour_remain;
        throw (flour);
    }
}
...
int main(int argc, char* argv[])
{
    ...
    flour_remain = atoi(argv[4]);
    eggs_remain = atoi(argv[5]);
    apples_remain = atoi(argv[6]);
    
    bool flag = 1;  // If any exception happens, flag will be changed to 0.
